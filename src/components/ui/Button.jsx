...
function Button({type="button",onClick,children,className,variant}){
    const variantClasses={
        primary:'px-3 py-1 flex items-center gap-2 hover:bg-gray-700 cursor-pointer transition-colors duration-300 rounded-[25px]',
        ...
        fourth:'px-4 py-2 border hover:bg-neutral-600  text-[14px] rounded-3xl',
        five:'px-3 flex justify-center items-center gap-1 hover:bg-neutral-600 text-[14px] rounded-3xl'
    }
    return(
